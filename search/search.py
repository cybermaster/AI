...
# 		    add the node to the explored set, adding the resulting node to the frontier
    ...
    while True:
        ...
        if not nextNode[0] in explored :
            ...
            for i in range( len(successors )) :
                ...
                frontier.push( ( successors[i][0], path ))
...
def uniformCostSearch(problem):
    ...
    startState = (problem.getStartState(), {})
    frontier.push(startState, problem.getCostOfActions(startState[1]) )
    explored = set([])
    ...
    while True :
        ...
        if not nextNode[0] in explored :
            ...
            for i in range( len(successors )) :
                path = list(nextNode[1])
                path.append(successors[i][1])
                frontier.push( ( successors[i][0], path ), problem.getCostOfActions(path))
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    frontier.push(startState, problem.getCostOfActions(startState[1]) + startEstCost )
    explored = set([])
